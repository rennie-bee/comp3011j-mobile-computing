...
/*
This class helps the MapActivity to work, provided by Baidu.
URL: "https://lbsyun.baidu.com/index.php?title=androidsdk"
This tool class mainly implements three functions:
    1. Calculate the distance between two points on the ground
    2. Calculate the area of a polygon on the ground
    3.Calculate whether a point is inside the polygon
 */
...
public class MapBaiduUtil {
    ...
    public static double getShortDistance(double lon1, double lat1, double lon2, double lat2) {
        ...
        dy = DEF_R * (ns1 - ns2);
        // Pythagorean theorem finds the length of the hypotenuse
